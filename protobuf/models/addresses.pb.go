...
func (PhoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_addresses_proto_enumTypes[0].Descriptor()
}

func (PhoneType) Type() protoreflect.EnumType {
	return &file_addresses_proto_enumTypes[0]
}
...
func (x *Person_PhoneNumber) Reset() {
	*x = Person_PhoneNumber{}
	mi := &file_addresses_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Person_PhoneNumber) Descriptor() ([]byte, []int) {
	return file_addresses_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_addresses_proto_rawDesc = "" +
	"\n" +
	"\x0faddresses.proto\x12\btutorial\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x02\n" +
	"\x06Person\x12\x12\n" +
...
var (
	...
	file_addresses_proto_rawDescData []byte
)

func file_addresses_proto_rawDescGZIP() []byte {
	file_addresses_proto_rawDescOnce.Do(func() {
		file_addresses_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_addresses_proto_rawDesc), len(file_addresses_proto_rawDesc)))
	})
	return file_addresses_proto_rawDescData
}

var file_addresses_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_addresses_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_addresses_proto_goTypes = []any{
...
func file_addresses_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_addresses_proto_rawDesc), len(file_addresses_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_addresses_proto_enumTypes,
